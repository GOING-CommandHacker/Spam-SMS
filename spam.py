...
apierrorall = '''
	...
	try:
		...
		print('\033[32m[สำเร็จ]            ')
	except:
		print('\033[31m[ล้มเหลว]            ')
	try:
	...
	try:
'''
phoneinformationoh = input('\033[36mกรอกเบอร์ (ลบ0นำหน้าออก): \033[35m')
ohmygoddkeyphone = '66'
_phone = ohmygoddkeyphone+phoneinformationoh
